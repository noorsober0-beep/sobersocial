    ...
    <main className="relative min-h-screen overflow-hidden bg-cream text-espresso">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-3xl flex-col justify-center px-6 py-20 text-center sm:px-8">
        ...
        <motion.div
          ...
          className="mx-auto mt-12 w-full max-w-xl rounded-[2rem] border border-espresso/10 bg-white/90 p-8 shadow-soft"
        >
          ...
          <form className="mt-6 flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <motion.button
              ...
              className="inline-flex h-14 items-center justify-center rounded-full bg-terracotta px-6 text-sm font-semibold text-white transition duration-300 ease-out hover:bg-[#9a4024] hover:shadow-soft"
            >
